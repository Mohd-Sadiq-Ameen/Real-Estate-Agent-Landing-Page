...
export default function CTABanner() {
  return (
    <section className="relative py-20 md:py-28 lg:py-32 bg-[#0F1923] overflow-hidden">
      ...
      <div
        className="w-full max-w-[1400px] mx-auto px-6 md:px-8 lg:px-10 relative z-10"
        style={{ maxWidth: "1400px", marginLeft: "auto", marginRight: "auto" }}
      >
        <div className="flex flex-col items-center justify-center text-center">
          <div className="flex flex-wrap justify-center gap-4 md:gap-6 mb-6 md:mb-8 text-[#C9A84C] text-lg tracking-[0.25em] uppercase">
          ...
          <h2 className="font-display text-5xl sm:text-6xl md:text-7xl lg:text-8xl text-white font-normal leading-[1.1] mb-4 md:mb-6">
            Find Premium Properties in <br />
            <span className="text-[#C9A84C] italic">
              South Delhi Without Stress
            </span>
          </h2>

          <p className="w-full max-w-2xl md:max-w-3xl lg:max-w-4xl mx-auto text-center text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed md:leading-[1.8] text-white/60 mb-8 md:mb-10 lg:mb-12 px-2 sm:px-4">
            Buy, rent or sell builder floors, luxury homes, and commercial
            spaces with verified listings and end-to-end support.
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4 md:gap-6">
          <a
            ...
            className="flex items-center justify-center gap-3 bg-[#25D366] text-white px-6 sm:px-8 md:px-10 py-4 sm:py-5 md:py-6 font-bold tracking-wider text-sm sm:text-base md:text-lg uppercase hover:bg-[#20B859] transition-all duration-300 rounded-xl shadow-lg hover:shadow-xl hover:-translate-y-0.5 w-full sm:w-auto"
          ...
          <a
            ...
            className="flex items-center justify-center gap-3 border-2 border-white/30 text-white px-6 sm:px-8 md:px-10 py-4 sm:py-5 md:py-6 font-bold tracking-wider text-sm sm:text-base md:text-lg uppercase hover:bg-white/10 hover:border-[#C9A84C] transition-all duration-300 rounded-xl w-full sm:w-auto"
            style={{ padding: "1rem 1.5rem" }}
          >
            <Phone size={20} />
            Talk to Agent
        ...
        <div className="mt-10 md:mt-12 flex flex-wrap justify-center gap-2 md:gap-3 text-lg text-white/40">
          <span>No spam</span>
          <span>•</span>
